 ...
 *
 * Name and description are fixed (not env-driven) because the handler is a
 * stub specific to TypeScript snippets — renaming it would be cosmetic only
 * without a matching handler swap. If you need a different tool for a
 * different domain, replace the handler below.
 */
